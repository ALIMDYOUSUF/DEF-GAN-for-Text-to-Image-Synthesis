...
parser.add_argument('--train_img_dir', type=str, default='../dataset/cub/train')
parser.add_argument('--train_attr_path', type=str, default='../dataset/cub/list_attr_cub_train.txt')
parser.add_argument('--test_img_dir', type=str, default='../dataset/cub/test')
parser.add_argument('--test_attr_path', type=str, default='../dataset/cub/list_attr_cub_test.txt')
parser.add_argument('--selected_attrs', '--list', nargs='+', help='selected attributes for the cub dataset',
                        default=['This bird is red and brown, with a stubby beak'])
parser.add_argument('--celeba_crop_size', type=int, default=178, help='crop size for the cub dataset')
